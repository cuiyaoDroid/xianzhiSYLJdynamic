...
public class KeyworkAndRecordHolder {
	...
	private float passenger_cnt;
	private float packet_cnt;
	private float passenger_rcpt;
	private float catering_rcpt;
	private float passenger_miss;
	private float receipts_miss;
	private float worker_miss;
	...
	public float getPassenger_cnt() {
		return passenger_cnt;
	}
	public void setPassenger_cnt(float passenger_cnt) {
		this.passenger_cnt = passenger_cnt;
	}
	public float getPacket_cnt() {
		return packet_cnt;
	}
	public void setPacket_cnt(float packet_cnt) {
	...
	public float getPassenger_miss() {
		return passenger_miss;
	}
	public void setPassenger_miss(float passenger_miss) {
	...
	public float getWorker_miss() {
		return worker_miss;
	}
	public void setWorker_miss(float worker_miss) {
		this.worker_miss = worker_miss;
	}
	public KeyworkAndRecordHolder(int train_id, String context,
			float passenger_cnt, float packet_cnt, float passenger_rcpt,
			float catering_rcpt, float passenger_miss, float receipts_miss,
			float worker_miss,String notes) {
		super();
		this.train_id = train_id;
		this.context = context;
		this.passenger_cnt = passenger_cnt;
