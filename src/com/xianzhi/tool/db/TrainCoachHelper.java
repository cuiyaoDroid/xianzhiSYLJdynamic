...
public class TrainCoachHelper extends DBHelper {
	...
	public long insert(TrainCoachHolder content) {
	...
	private TrainCoachHolder getDataCursor(Cursor cursor){
		...
		TrainCoachHolder holder=new TrainCoachHolder(coach_no, train_no, coach_type, limit1, trainDate, trainCode,train_id);
