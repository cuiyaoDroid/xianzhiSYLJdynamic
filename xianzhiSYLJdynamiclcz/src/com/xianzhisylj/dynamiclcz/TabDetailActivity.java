...
public class TabDetailActivity extends TabActivity {
	...
	private void refreshTrainDynamic(){
		...
		final ArrayList<TrainDynamicHolder> holders=helper.selectDataTrainId(train_id);
		helper.close();
		int i=0;
		mid=0;
		...
		new Handler().postDelayed(new Runnable() {
			...
			public void run() {
				...
				horizontalScrollView.smoothScrollTo(mid*train_info_layout.getWidth()/holders.size(), 0);
			}
		}, 200);
